...
src_prepare() {
	rm .gitmodules || die
	rmdir "${S}"/third_party/{aes_128,binutils-ppc-cygwin,discord-rpc} || die
...
src_install() {
	dobin "build/bin/Linux/Release/xenia-canary-app"
	make_desktop_entry xenia-canary-app "Xenia Canary" "" "Game;Emulator"
	dodoc README.md
}
