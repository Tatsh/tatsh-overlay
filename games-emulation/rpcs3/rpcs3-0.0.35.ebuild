...
HIDAPI_SHA="6bfdcf7368169efe1b745cd4468d45cda05ef8de"
...
PATCHES=(
	"${FILESDIR}/${P}-0001-versioning.patch"
	"${FILESDIR}/${P}-0002-add-use_wayland.patch"
	"${FILESDIR}/${P}-0003-allow-use-of-system-spirv-an.patch"
	"${FILESDIR}/${P}-0004-allow-system-cubeb.patch"
	"${FILESDIR}/${P}-0005-support-for-system-miniupnpc.patch"
	"${FILESDIR}/${P}-0006-remove-extra.patch"
	"${FILESDIR}/${P}-0007-allow-system-rtmidi.patch"
	"${FILESDIR}/${P}-0008-add-missing-headers.patch"
	"${FILESDIR}/${P}-0009-allow-use-of-system-zstd.patch"
	"${FILESDIR}/${P}-0010-fix-openal-header-include.patch"
)
