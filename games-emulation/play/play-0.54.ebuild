...
DEPS_SHA="2b976d68fef32a59f5675362100ecbd083d16b58"
...
ZSTD_SHA="f349d18776001f39791323e59ef2395983c1cd2e"
...
PATCHES=( "${FILESDIR}/${PN}-0001-source-system-deps.patch" )
...
src_prepare() {
	...
	{ cd deps/Framework && eapply -p1 "${FILESDIR}/${P}-framework-system-deps.patch"; } || die
	cmake_src_prepare
}
