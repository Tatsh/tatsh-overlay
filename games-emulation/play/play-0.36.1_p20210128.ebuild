...
MY_PV="${PV:0:4}-${PV:5:1}"
PLAY_SHA="6f3f87a4a55a166838b11b9161ccb138f8e5a267"
...
SRC_URI="https://github.com/jpd002/Play-/archive/${PLAY_SHA}.tar.gz -> ${P}.tar.gz
...
S="${WORKDIR}/${MY_PN}-${PLAY_SHA}"

PATCHES=(
	"${FILESDIR}/${PN}-system-deps.patch"
	"${FILESDIR}/${PN}-undefined-var.patch"
)
