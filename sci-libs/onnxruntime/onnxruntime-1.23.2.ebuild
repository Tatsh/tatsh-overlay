...
PATCHES=(
	"${FILESDIR}/${PN}-relax-the-dependency-on-flatbuffers.patch"
	"${FILESDIR}/${PN}-use-system-libraries.patch"
	"${FILESDIR}/${PN}-abseil-fix.patch"
	"${FILESDIR}/${PN}-fix-for-older-onnx.patch"
)
...
src_configure() {
	...
	local mycmakeargs=(
		...
		"-Donnxruntime_BUILD_NODEJS=$(usex nodejs)"
