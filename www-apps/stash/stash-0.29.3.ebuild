...
EGO_SUM=(
	...
	"github.com/PuerkitoBio/goquery v1.10.3/go.mod"
	...
	"github.com/Yamashou/gqlgenc v0.32.1/go.mod"
	...
	"github.com/bool64/dev v0.2.28/go.mod"
	...
	"github.com/dop251/goja v0.0.0-20231027120936-b396bb4c349d/go.mod"
...
src_prepare() {
	sed -re '/.*\$\(eval LDFLAGS \+=.*/d' -i Makefile || die
	yarn_src_prepare
}
