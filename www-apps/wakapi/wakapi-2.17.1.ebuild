...
EGO_SUM=(
	...
	"github.com/alitto/pond/v2 v2.6.0/go.mod"
	...
	"github.com/duke-git/lancet/v2 v2.3.8/go.mod"
	...
	"github.com/getsentry/sentry-go v0.36.2/go.mod"
	"github.com/getsentry/sentry-go v0.38.0"
	"github.com/getsentry/sentry-go v0.38.0/go.mod"
	"github.com/getsentry/sentry-go v0.40.0"
	"github.com/getsentry/sentry-go v0.40.0/go.mod"
	"github.com/getsentry/sentry-go v0.41.0"
	"github.com/getsentry/sentry-go v0.41.0/go.mod"
	...
	"github.com/go-jose/go-jose/v3 v3.0.1/go.mod"
	...
	"github.com/go-openapi/jsonreference v0.21.2/go.mod"
	...
	"github.com/go-openapi/spec v0.22.0/go.mod"
	...
	"github.com/go-openapi/swag/conv v0.25.3/go.mod"
	...
	"github.com/go-openapi/swag/jsonname v0.25.3/go.mod"
	...
	"github.com/go-openapi/swag/jsonutils v0.25.3/go.mod"
	...
	"github.com/go-openapi/swag/loading v0.25.3/go.mod"
	...
	"github.com/go-openapi/swag/stringutils v0.25.3/go.mod"
	...
	"github.com/go-openapi/swag/typeutils v0.25.3/go.mod"
	...
	"github.com/go-openapi/swag/yamlutils v0.25.3/go.mod"
	...
	"github.com/gofrs/uuid/v5 v5.4.0/go.mod"
	...
	"github.com/jackc/pgx/v5 v5.7.6/go.mod"
	...
	"github.com/microsoft/go-mssqldb v1.8.2/go.mod"
	"github.com/microsoft/go-mssqldb v1.9.3"
	"github.com/microsoft/go-mssqldb v1.9.3/go.mod"
	"github.com/microsoft/go-mssqldb v1.9.4"
	"github.com/microsoft/go-mssqldb v1.9.4/go.mod"
	"github.com/microsoft/go-mssqldb v1.9.5"
	"github.com/microsoft/go-mssqldb v1.9.5/go.mod"
	...
	"github.com/oauth2-proxy/mockoidc v0.0.0-20240214162133-caebfff84d25/go.mod"
	...
	"github.com/samber/slog-multi v1.5.0/go.mod"
	"github.com/samber/slog-multi v1.6.0"
	"github.com/samber/slog-multi v1.6.0/go.mod"
	"github.com/samber/slog-multi v1.7.0"
	"github.com/samber/slog-multi v1.7.0/go.mod"
	...
	"github.com/samber/slog-sentry/v2 v2.10.1/go.mod"
	...
	"github.com/swaggo/swag v1.16.6/go.mod"
	...
	"golang.org/x/exp v0.0.0-20251113190631-e25ba8c21ef6/go.mod"
	...
	"golang.org/x/image v0.33.0/go.mod"
	"golang.org/x/image v0.34.0"
	"golang.org/x/image v0.34.0/go.mod"
	"golang.org/x/image v0.35.0"
	"golang.org/x/image v0.35.0/go.mod"
	...
	"modernc.org/libc v1.66.10/go.mod"
	"modernc.org/libc v1.67.0"
	"modernc.org/libc v1.67.0/go.mod"
	"modernc.org/libc v1.67.2"
	"modernc.org/libc v1.67.2/go.mod"
	...
	"modernc.org/sqlite v1.39.0/go.mod"
	"modernc.org/sqlite v1.39.1"
	"modernc.org/sqlite v1.39.1/go.mod"
	"modernc.org/sqlite v1.40.0"
	"modernc.org/sqlite v1.40.0/go.mod"
