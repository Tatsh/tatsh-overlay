...
EGO_SUM=(
	...
	"github.com/alecthomas/kong v0.2.11/go.mod"
	...
	"github.com/slongfield/pyfmt v0.0.0-20180124071345-020a7cb18bca/go.mod"
	...
	"github.com/wakatime/chroma v0.8.2-wakatime.7"
	"github.com/wakatime/chroma v0.8.2-wakatime.7/go.mod"
	"github.com/wakatime/goInfo v0.1.0-wakatime.2"
	"github.com/wakatime/goInfo v0.1.0-wakatime.2/go.mod"
	"github.com/wakatime/goInfo v0.1.0-wakatime.3"
	"github.com/wakatime/goInfo v0.1.0-wakatime.3/go.mod"
	"github.com/wakatime/goInfo v0.1.0-wakatime.4"
	"github.com/wakatime/goInfo v0.1.0-wakatime.4/go.mod"
	"github.com/wakatime/goInfo v0.1.0-wakatime.5"
	"github.com/wakatime/goInfo v0.1.0-wakatime.5/go.mod"
	"github.com/wakatime/goInfo v0.1.0-wakatime.6"
	"github.com/wakatime/goInfo v0.1.0-wakatime.6/go.mod"
...
SRC_URI="https://github.com/wakatime/wakatime-cli/archive/refs/tags/v${PV}.tar.gz -> ${P}.tar.gz
	${EGO_SUM_SRC_URI}"
...
src_prepare() {
	sed -r -e 's/^LD_FLAGS=-s /LD_FLAGS=/' -i Makefile || die
	default
}

src_compile() {
	use amd64 && emake "COMMIT=${PV}" "VERSION=${PV}" "BINARY_NAME=${PN}" build-linux-amd64
	use arm64 && emake "COMMIT=${PV}" "VERSION=${PV}" "BINARY_NAME=${PN}" build-linux-arm64
	use arm && emake "COMMIT=${PV}" "VERSION=${PV}" "BINARY_NAME=${PN}" build-linux-arm
	use x86 && emake "COMMIT=${PV}" "VERSION=${PV}" "BINARY_NAME=${PN}" build-linux-386
}
